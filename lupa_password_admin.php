...
if (isset($_POST['reset'])) {
  ...
  $data = mysqli_fetch_array($cek, MYSQLI_BOTH);
...
<head>
  <meta charset="utf-8">
  <title>Lupa Password | Admin SI BKK</title>
    ...
    <div class="login-box-body">
      ...
      <form method="POST" autocomplete="off">
        ...
        <div class="form-group">
          <input type="text" class="form-control" placeholder="Masukkan Username Admin"
        ...
        <div class="row">
          <div class="col-xs-6">
            <button type="button" onclick="window.location='login_admin.php'" class="btn btn-warning btn-block">
