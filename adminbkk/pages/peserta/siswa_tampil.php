                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label for="tahun" class="col-lg-3 control-label"
                                        style="text-align: left; margin-left:20px;">Tahun</label>
                                    <div class="col-lg-9">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons-modern">
                                    <a href="?halaman=siswa_detail&kode=<?php echo $data['nisn']; ?>"
                                        class="btn-action-modern btn-detail" title="Detail">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                            <fieldset>
                                <div class="form-group">
                                    <label for="tahun" class="col-lg-3 control-label"
                                        style="text-align: left;">Tahun</label>
                                    <div class="col-lg-9">
                                        <select class="form-control" name="tahun" id="tahun">
                                            <option value="">- Pilih Tahun -</option>
                                            <?php
            ...
            <table id="example1" class="modern-table">
                ...
                <tbody>
                    ...
                    if ($tahun !== '' && is_numeric($tahun)) {
                        ...
                        $sql = "
        SELECT *
        FROM tb_siswa, tb_sekolah
        WHERE tb_siswa.id_sekolah = tb_sekolah.id_sekolah
        AND tb_sekolah.id_sekolah = '$data_username'
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons-modern">
                                    ...
                                    <a href="?halaman=siswa_ubah&kode=<?php echo $data['nisn']; ?>"
