                    ...
                    <div class="col-left">
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="text" class="form-control-modern" name="txtusername" placeholder="Masukkan Username" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="text" class="form-control-modern" name="txtnama" placeholder="Masukkan Nama Lengkap" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="password" class="form-control-modern" name="txtpassword" placeholder="Masukkan Password" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-right">
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="email" class="form-control-modern" name="txtemail" placeholder="contoh@email.com" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="text" class="form-control-modern" name="txtalamat" placeholder="Masukkan Alamat Lengkap" required>
                            </div>
                        </div>
