...
if (isset($_POST['reset'])) {
  ...
  if (!$data_siswa) {
    ...
    // cek tb_user
    $cek_user = mysqli_query($con, "SELECT * FROM tb_user WHERE id_user='$id_user' AND role='siswa'");
    ...
    if (!$data_user) {
      ...
      if ($password_baru != $konfirmasi) {
        ...
        if (strlen($password_baru) < 6) {
          ...
          SET password='$hash' 
          WHERE id_user='$id_user' AND role='siswa'");
...
<head>
  <meta charset="utf-8">
  <title>Lupa Password | Alumni SMK Negeri 7 Surabaya</title>
    ...
    * {
    ...
    body {
      background: linear-gradient(135deg, rgba(102, 126, 234, 0.28) 0%, rgba(118, 75, 162, 0.1) 100%),
                  url('../adminbkk/dist/img/bg-smkn7.png');
...
<body>
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg">Lupa Password Siswa/Alumni</p>
      ...
      <form method="POST" autocomplete="off">
        ...
        <div class="form-group">
          ...
          name="konfirmasi" autocomplete="new-password" required>
          <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>

        <div class="row">
          <div class="col-xs-6">
            <button type="button" onclick="window.location='peserta.php'" class="btn btn-warning btn-block">
